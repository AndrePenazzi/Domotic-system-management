...
public class UnitaImmobiliare implements Serializable {
     ...
     */
    public void inserisciRegola(Antecedenti antecedenti, Attuatore attuatore, ModOperativa modOperativa) {
        regole.add(new Regola());
        int i = regole.size();
        regole.get(i - 1).inserisciAntecedenti(antecedenti);
     ...
     */
    public void inserisciRegola(Antecedenti antecedenti, Attuatore attuatore, ModOperativa modOperativa, Orologio start) {
        regole.add(new Regola());
        int i = regole.size();
        regole.get(i - 1).inserisciAntecedenti(antecedenti);
