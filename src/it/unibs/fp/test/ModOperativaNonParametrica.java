...
public class ModOperativaNonParametrica {
    ...
    private static it.unibs.fp.model.modalitaOperativa.ModOperativaNonParametrica nuovaModOperativaNonParamentrica;

    @Test
    public void inizializzazioneTest(){
        it.unibs.fp.model.modalitaOperativa.ModOperativaNonParametrica modOperativaParamentrica = new it.unibs.fp.model.modalitaOperativa.ModOperativaNonParametrica();
        assertEquals("",modOperativaParamentrica.getNome());
    }

    @Test
    public void assegnazioneTest() {
        nuovaModOperativaNonParamentrica = new it.unibs.fp.model.modalitaOperativa.ModOperativaNonParametrica(NOME_MODALITA_OPERATIVA_PARAMETRICA, VALORE);
